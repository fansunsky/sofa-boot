package com.dodolu.sofa;

import com.dodolu.sofa.endpoint.facade.SampleRestFacade;
import com.dodolu.sofa.endpoint.impl.SampleRestFacadeRestImpl;
import com.dodolu.sofa.endpoint.model.DemoUserModel;
import com.dodolu.sofa.endpoint.response.RestSampleFacadeResp;
 ...
 */
@ImportResource({"classpath*:META-INF/sofa-web-module/*.xml"})
